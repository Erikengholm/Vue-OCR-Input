  ...
  <div class="container d-flex justify-content-center mt-50 mb-50">
    <div class="row">
      <div class="col-md-12 text-right mb-3">
        <button class="btn btn-primary" @click="test">download pdf</button>
      </div>
      <div class="col-md-12">
        <div class="card" id="invoice" ref="myDiv">
              ...
              <div class="col-sm-6">
                <div class="mb-4">
                  <div class="text-sm-right">
                    <h4 class="invoice-color mb-2 mt-md-2" v-text="OCR"></h4>
            ...
            <div class="d-md-flex flex-md-wrap">
              <div class="pt-2 mb-3 wmin-md-400 ml-auto">
                ...
                <div class="text-right mt-3">
                  <button type="button" @click="unique" class="btn btn-primary">
                    <b><i class="fa fa-paper-plane-o mr-1"></i></b> Send invoice
                  </button>
                </div>
              </div>
            </div>
...
import { OCRCollection } from '../firebase'
  ...
  methods: {
    setOCR() {
      do {
        ...
        var number = firstChar.toString()
        firstChar = null
        for (var count = 0; count <= 3; count++) {
          let letter = Math.floor(Math.random() * 9) + 0
          if (this.rules()) {
            count--
          } else {
            number = number + letter.toString()
          }
        }
        this.OCR = '#' + number + '54'
      } while (this.unique())
    ...
    async unique() {
      const snapshot = await OCRCollection.where('OCRNumber', '==', this.OCR).get()
      if (snapshot.empty) {
        return true
      } else {
        return false
    ...
    /* async unique() {
      ...
      snapshot.forEach((doc) => {
        console.log(doc.id, '=>', doc.data().ORCNumber)
      })
    }, */
    test() {
      const invoice = this.$refs.myDiv
      console.log(invoice)
      console.log(window)
      var opt = {
        margin: 1,
