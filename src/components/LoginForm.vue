    ...
    <div class="login-right">
      ...
      >
        ...
        <div class="form-group form-password">
          <input
            @keyup="capslockwarner()"
            id="Password"
            placeholder="Password"
            :type="value"
            v-model="password"
          />
          <font-awesome-icon class="pointer" :icon="icon" @click="switchVisibility()" />
        </div>
        <div>
          <p class="error-text" v-text="error"></p>
        </div>
        ...
        <div class="button-area">
          ...
          <router-link to="/registration">not a member registrat here</router-link>
        </div>
      </form>
    </div>
  </div>
...
.open .login-left {
  -webkit-transform: translateX(-330px) translateZ(0) translateY(-180px);
  transform: translateX(-330px) translateZ(0) translateY(-180px) scale(0.1);
}
...
.login-right {
  ...
  right: 0;
  width: 475px;
  -webkit-transform: translateX(800px) translateZ(0);
